...
import com.example.wazitoecommerce.ui.theme.screens.workouts.WorkoutScreens
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(WORKOUTS_URL){
            WorkoutScreens(navController = navController)
        }
        composable(MEALS_URL){
